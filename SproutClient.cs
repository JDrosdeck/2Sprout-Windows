...
class SproutClient
{
    ...
    {
        GetHtml("http://2sprout.com/client/disconnect/" + port + "/" + apiKey + "/"); 
    ...
    public static bool RegisterClient()
    {
        ...
        String input = GetHtml("http://2sprout.com/client/connect/" + port + "/" + apiKey + "/"); 
    ...
    public static void GetSecretKey()
    {
        ...
        for (; ; )
        {
            ...
            lock (keyLock)
            {
                input = GetHtml("http://2sprout.com/client/keepalive/" + port + "/" + apiKey + "/"); 
    ...
    public static String GetHtml(String url, String post)
    {
