...
for x in xrange(0,10):
	tempMessage = "^120511^"+ str(x) + "^0^TESTdddkjESTES125.99<\"/price><spdroutcast><url>www.amazon.com/prod1d=43453</url><title>gold watch</title></sproutcast><price>125.99</price>kjg;" + str(x)
